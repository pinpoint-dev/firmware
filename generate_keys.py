...
# Code originally from https://github.com/dchristl/macless-haystack/blob/main/generate_keys.py 
...
keyfile64 = open(OUTPUT_FOLDER + prefix + '_keyfile_b64', 'w')
